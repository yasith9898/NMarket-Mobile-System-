            ...
            <div class="container-fluid">
                <div class="row text-sm-center text-md-start">
                    ...
                    <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                        <h5 class="text-uppercase text-warning mb-4">Nmarket</h5>
                        <p>Here we are the nmarket.lk&trade; to support you for accomplish your dessire by selling high
                            quality products.</p>
                    </div>

                    <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                        <p>Copyright &copy; 2022 nmarket All Rights Reserved.</p>
                    </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                        ...
                        <p><i class="bi bi-at"></i> nmarket@gmail.com</p>
                    ...
                    <p class="text-center">Developed By <a href="https://twicklerlk.com" target="_blank"> twickler Software Solution</a></p>
                </div>
            </div>
